    ...
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col items-center justify-center h-full gap-8 container mx-auto">
          ...
          {/* Animated Title */}
          <h1 className="text-white text-4xl font-medium flex gap-1">
            {text.map((char, i) => (
              <motion.span
                key={i}
          ...
          <motion.div
            ...
            className="grid grid-cols-5 gap-4 bg-white/10 backdrop-blur-xl p-8 rounded-2xl shadow-2xl w-[85%] max-w-4xl"
          >
            <input
              className="p-3 rounded-lg text-black bg-white/80"
              placeholder="Pick-up location"
            />
            <input className="p-3 rounded-lg text-black bg-white/80" type="date" />
            <input className="p-3 rounded-lg text-black bg-white/80" type="time" />
            <input className="p-3 rounded-lg text-black bg-white/80" type="date" />
            <button className="bg-teal-600 text-white rounded-lg px-5 py-3 text-lg font-medium shadow-lg hover:bg-teal-700 transition">
              Search
            </button>
