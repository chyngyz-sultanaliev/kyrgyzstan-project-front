     ...
     <div className="flex flex-col lg:flex-row items-center justify-around w-full min-h-[80vh] bg-[#00000084] gap-10 px-4">
       <div className="flex flex-col gap-5">
        ...
        <div className="flex gap-4 mt-7">
          <div className="overflow-hidden w-24 h-24 sm:w-32 sm:h-32 lg:w-40 lg:h-40 bg-green-950 rounded-md">
            <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/640278495.jpg?k=d01b304a29089108ae381173be12460b5524ea2ce71cf3203fa2dcea36d370a8&o=" alt="img" className="w-full h-full object-cover"/>
          </div>
          <div className="overflow-hidden w-24 h-24 sm:w-32 sm:h-32 lg:w-40 lg:h-40 bg-green-950 rounded-md">
            <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/640278495.jpg?k=d01b304a29089108ae381173be12460b5524ea2ce71cf3203fa2dcea36d370a8&o=" alt="img" className="w-full h-full object-cover"/>
          </div>
