     ...
     <div className="grid grid-cols-4 grid-rows-1 justify-center justify-items-center gap-4">
        ...
        <div className="p-5">
          ...
          <div className="flex justify-between items-center mt-4">
            <p className="font-semibold text-[17px]">
              от 10 000 ₽ <span className="text-gray-500 text-sm">/ сутки</span>
            </p>
      ...
      <div className="w-[320px] rounded-2xl overflow-hidden shadow-md bg-white">
        ...
        <div className="p-5">
          ...
          <button className="m-5 w-[200px] mx-auto h-7 bg-[#0a8791] text-white flex items-center justify-center rounded-lg">
  Перейти в каталог
</button>
    </section>
  );
