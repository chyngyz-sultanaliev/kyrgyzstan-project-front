...
const TourDetail = ({ params }: Props) => {
  ...
  if (!tour) return notFound(); // ID туура келбесе 404 чыгат
  ...
  return (
    <div className="p-10">
      ...
      <p className="mt-2 font-semibold">Price: {tour.price} KGS</p>
      <Link href="/main/tour" className="text-blue-600 mt-4 block">
        ← Back to Categories
      </Link>
    </div>
  );
